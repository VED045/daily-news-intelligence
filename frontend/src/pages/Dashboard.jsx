  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="mb-10 animate-fade-in">
        ...
        <p className={`text-base max-w-xl ${dark ? 'text-slate-400' : 'text-slate-500'}`}>
      ...
      {trends && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10 animate-slide-up">
          {[
            { label: 'Total Articles', value: trends.total_articles, icon: Newspaper, color: 'text-cyan-500' },
        ...
        <div className="xl:col-span-2">
          ...
          {loading ? (
            ...
            <div className={`rounded-2xl p-10 text-center ${dark ? 'glass text-slate-500' : 'bg-white border border-slate-200 text-slate-400 shadow-sm'}`}>
              ...
              <p className="text-sm">Click <strong className="text-primary-500">Run Pipeline</strong> in the navbar to fetch today's news.</p>
            </div>
          )}
        </div>
